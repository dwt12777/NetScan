...
Also, by default cached values are used for up to 365 days after being added to the cache.  This is controlled in a config file found wherever you installed the program, typically:

C:\Program Files\ReardenTools\NetScan\NetScan.dll.config 
